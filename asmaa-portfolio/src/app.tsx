...
const App: React.FC = () => {
  ...
  <h1 className="text-4xl font-bold text-blue-700">Asmaa J. M. Alshaikhdeeb</h1>
  <p className="text-lg mt-2 mb-4">Pharmacist | Data Analyst | Health Informatics</p>
...
in data science, data analysis, and data engineering.
  ...
  {/* Button on its own line with margin on top */}
  <a
    href="/asmaa_cv.pdf"
    download
    target="_blank"
  ...
  >
    ...
    className="p-6 max-w-4xl mx-auto">
        ...
        <ul className="space-y-2">
          <li>
            <strong>Master of Informatics</strong> – Universiti Sains Malaysia (2022)
          </li>
          <li>
            <strong>Bachelor of Pharmacy</strong> – Al-Azhar University, Gaza (2013)
          </li>
        </ul>
      </section>
